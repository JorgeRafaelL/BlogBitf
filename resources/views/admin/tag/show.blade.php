	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
				...
				<a href="{{ route('tag.create') }}" class="btn btn-primary col-lg-offset-5">Nueva etiqueta</a>
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ $tag->name }}</td>
										<td>{{ $tag->slug }}</td>
										<td><a href="{{ route('tag.edit', $tag->id) }}"><span class="glyphicon glyphicon-edit text-success"
